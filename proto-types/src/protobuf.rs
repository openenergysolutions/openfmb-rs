...
pub struct MessageOptions {
    ...
    #[prost(bool, optional, tag="51000", default="false")]
    pub openfmb_profile: ::std::option::Option<bool>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FieldOptions {
    ...
    /// Extension for OpenFMB
    #[prost(bool, optional, tag="50000", default="false")]
    pub parent_message: ::std::option::Option<bool>,

    #[prost(bool, optional, tag="50001", default="false")]
    pub required_field: ::std::option::Option<bool>,

    #[prost(int32, optional, tag="50002", default="0")]
    pub multiplicity_min: ::std::option::Option<i32>,

    #[prost(int32, optional, tag="50003", default="0")]
    pub multiplicity_max: ::std::option::Option<i32>,

    #[prost(bool, optional, tag="50004", default="false")]
    pub uuid: ::std::option::Option<bool>,

    #[prost(bool, optional, tag="50005", default="false")]
