...
use openfmb_messages::evsemodule::EvseDiscreteControlProfile;
use openfmb_messages::{commonmodule::*, essmodule::*};

use crate::{error::*, ControlProfileExt, OpenFMBExt};

impl OpenFMBExt for EvseDiscreteControlProfile {
...
impl ControlProfileExt for EvseDiscreteControlProfile {}
